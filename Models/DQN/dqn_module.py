...
class DQNAgent:
    ...
    def train(self, state, action, reward, next_state, done):
        ...
        for minibatch_state, minibatch_action, minibatch_reward, minibatch_next_state, minibatch_done in minibatch:
            minibatch_states.append(np.array(minibatch_state).flatten())  # Flatten the state
            minibatch_next_states.append(np.array(minibatch_next_state).flatten())  # Flatten the next state
